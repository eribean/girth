...
class TestJointMaximum(unittest.TestCase):
    ...
    def test_joint_regression_onepl(self):
        ...
        np.testing.assert_allclose(expected_output, output[1], 1e-4)
    ...
    def test_joint_regression_twopl(self):
        ...
        np.testing.assert_allclose(alphas, output[0], rtol=1e-4)
        np.testing.assert_allclose(betas, output[1], rtol=1e-4)
